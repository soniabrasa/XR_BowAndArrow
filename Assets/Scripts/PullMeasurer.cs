...
public class PullMeasurer : XRBaseInteractable {
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs args) {
        ...
        //Debug.Log("PullMeasurer.OnSelectEntered " + args.interactor);
    ...
    private void CheckForPull() {
        ...
        //Debug.Log("PullMeasurer.CheckForPull " + interactorPosition);
    ...
    public override bool IsSelectableBy(XRBaseInteractor interactor) {
        ...
        //Debug.Log("PullMeasurerIsSelectableBy" + IsDirectInteractor(interactor));
